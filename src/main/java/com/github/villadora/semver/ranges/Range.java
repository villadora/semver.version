...
public class Range {
	...
	/**
	 * Find the highest version in the list that satisfies the range, if none is
	 * found, return null
	 * 
	 * @param versions
	 * @return
	...
	/**
	 * Return true if the version is outside the bounds of the range in either
	 * the high or low direction.
	 * 
	 * @param version
	 * @return
	 */
